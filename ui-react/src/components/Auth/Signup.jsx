  ...
  return (
    <section id="register" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <form className="mt-5">
          <div className="mb-4">
            <label htmlFor="fullName" className={`${styles.input} text-white block mb-2`}>Full Name:</label>
            <input
              type="text"
              id="fullName"
          ...
          <div className="mb-4">
            <label htmlFor="email" className={`${styles.input} text-white block mb-2`}>Email:</label>
            <input
              type="email"
              id="email"
              className={`${styles.input} ${styles.input} px-4 py-2 w-full`}
          ...
          <div className="mb-6">
            <label htmlFor="password" className={`${styles.input} text-white block mb-2`}>Password:</label>
            <input
              type="password"
              id="password"
              className={`${styles.input} ${styles.input} px-4 py-2 w-full`}
